...
tmp_dat <- data %>% select(treatment,number,size,Cnodes,Ynodes)
...
#Now one has everything for P(T1>3) and P(T1>5), then one can go over the Simultaneous_CI.Rmd files row 141-182 to construct simultaneous CI.
